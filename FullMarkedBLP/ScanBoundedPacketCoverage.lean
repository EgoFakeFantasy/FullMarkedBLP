...
theorem scanRankReach_frozen_bounded_historical_coverage {lambda : Ordinal.{u}} {initial a : Pattern}
  ...
  obtain ⟨phi, mono, holds, records, certs⟩ :=
    scanRankReach_frozen_bounded_historical_certificates h entryRealization geometry processed events valid hr
