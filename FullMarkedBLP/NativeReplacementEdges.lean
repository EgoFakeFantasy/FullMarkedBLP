...
theorem rankRealization_native_replacement_edges {lambda : Ordinal.{u}} {a b : Pattern}
    ...
    target.RealizesEdges (rankOrdinalAction (nativeEmbeddingValues embedding r sources.length i))
  ...
  obtain ⟨actual, ha, hac⟩ := rankRealization_native_actual_block_edges h hr hp he hn hne
